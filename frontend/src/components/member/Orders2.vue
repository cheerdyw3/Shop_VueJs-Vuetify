        ...
        >
          ...
          <v-card class="pa-0 mt-1" elevation="1">
            <v-row no-gutters>
                      ...
                      <small>
                        <v-row no-gutters class="lineH">
                          ...
                          <v-col cols="3" class="pa-0 text-end">
                            <b
                              >฿{{ Number(orDetail.price).toLocaleString() }}</b
                            >
                          </v-col>
                        </v-row>
                      </small>
              ...
              <v-col cols="10" class="pa-0 text-end pr-3">
                <v-text-field height="10" label="หมายเลขพัสดุ" outlined dense></v-text-field>
              </v-col>
              <v-col cols="2" class="pa-0 text-end pr-3">
                <small class="text-caption lh1">
                  <v-btn
                    x-small
                    color="warning"
